...
The First step is inserting the csv file into R located in data_input and then installing the necessary plugins including `dplyr`, `dplyr`, `lubridate`, etc.

```{r}
#Read data csv
heart <- read.csv("heart_failure_clinical_records_dataset.csv")

library(knitr)               # Used for displaying graphics
library(dplyr)               # Used for data manipulation
library(lubridate)           # Used for date and time manipulation (used by 'glimpse' function)
library(ROSE)                # Used for oversampling (up-sampling) the data
